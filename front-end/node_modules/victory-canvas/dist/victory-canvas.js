...
/* harmony export */   "CanvasBar": function() { return /* binding */ CanvasBar; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/bar-helper-methods.js");
/* harmony import */ var victory_bar__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! victory-bar */ "../../victory-bar/es/path-helper-methods.js");
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.ts");
...
const evaluateProps = props => {
   ...
   * 3) `cornerRadius`
   */
  const style = (0,victory_bar__WEBPACK_IMPORTED_MODULE_1__.getStyle)(props.style, props);
  const barWidth = (0,victory_bar__WEBPACK_IMPORTED_MODULE_1__.getBarWidth)(props.barWidth, Object.assign({}, props, {
    style
  }));
  const cornerRadius = (0,victory_bar__WEBPACK_IMPORTED_MODULE_1__.getCornerRadius)(props.cornerRadius, Object.assign({}, props, {
    style,
    barWidth
  }));
...
const CanvasBar = props => {
  const {
    canvasRef
  } = (0,_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_2__.useCanvasContext)();
  ...
  const path2d = react__WEBPACK_IMPORTED_MODULE_0___default().useMemo(() => {
    const p = polar ? (0,victory_bar__WEBPACK_IMPORTED_MODULE_3__.getPolarBarPath)(modifiedProps, cornerRadius) : (0,victory_bar__WEBPACK_IMPORTED_MODULE_3__.getBarPath)(modifiedProps, barWidth, cornerRadius);
    return new Path2D(p);
  }, [polar, barWidth, cornerRadius, modifiedProps]);
  const previousPath = usePreviousValue(path2d);
  const draw = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback((ctx, path) => {
  ...
  const clearPreviousPath = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(ctx => {
    if (previousPath) {
      ctx.save();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CanvasCurve": function() { return /* binding */ CanvasCurve; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.ts");
...
const CanvasCurve = props => {
  const {
    ...
    clear,
    clip
  } = (0,_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__.useCanvasContext)();
  const {
    style,
    data
  } = props;
  ...
  const draw = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(ctx => {
    const line = victory_core__WEBPACK_IMPORTED_MODULE_2__.getLineFunction(props);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CanvasGroup": function() { return /* binding */ CanvasGroup; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.ts");
...
const CanvasGroup = props => {
  ...
  const clear = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(ctx => {
    return ctx.clearRect(0, 0, width, height);
  }, [width, height]);

  // This needs to be called in the child component to ensure it is called after the
  // shape is drawn
  const clip = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(ctx => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CanvasPoint": function() { return /* binding */ CanvasPoint; }
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var victory_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! victory-core */ "../../victory-core/es/victory-util/point-path-helpers.js");
...
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.ts");
...
const getPath = props => {
  ...
  const pathFunctions = {
    circle: victory_core__WEBPACK_IMPORTED_MODULE_1__.circle,
    square: victory_core__WEBPACK_IMPORTED_MODULE_1__.square,
    diamond: victory_core__WEBPACK_IMPORTED_MODULE_1__.diamond,
    triangleDown: victory_core__WEBPACK_IMPORTED_MODULE_1__.triangleDown,
    triangleUp: victory_core__WEBPACK_IMPORTED_MODULE_1__.triangleUp,
    plus: victory_core__WEBPACK_IMPORTED_MODULE_1__.plus,
    minus: victory_core__WEBPACK_IMPORTED_MODULE_1__.minus,
    star: victory_core__WEBPACK_IMPORTED_MODULE_1__.star,
    cross: victory_core__WEBPACK_IMPORTED_MODULE_1__.cross
  };
...
const evaluateProps = props => {
   ...
   * `symbol`
   */
  const size = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(props.size, props);
  const style = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateStyle(props.style, props);
  const symbol = victory_core__WEBPACK_IMPORTED_MODULE_2__.evaluateProp(props.symbol, props);
...
const CanvasPoint = props => {
  const {
    canvasRef
  } = (0,_hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_3__.useCanvasContext)();
  const modifiedProps = evaluateProps(props);
  const draw = react__WEBPACK_IMPORTED_MODULE_0___default().useCallback(ctx => {
    const {
      style
...
const CanvasContext = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createContext(undefined);
const useCanvasContext = () => {
  const context = react__WEBPACK_IMPORTED_MODULE_0___default().useContext(CanvasContext);
  if (!context) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CanvasBar": function() { return /* reexport safe */ _canvas_bar__WEBPACK_IMPORTED_MODULE_0__.CanvasBar; },
/* harmony export */   "CanvasCurve": function() { return /* reexport safe */ _canvas_curve__WEBPACK_IMPORTED_MODULE_2__.CanvasCurve; },
/* harmony export */   "CanvasGroup": function() { return /* reexport safe */ _canvas_group__WEBPACK_IMPORTED_MODULE_1__.CanvasGroup; },
/* harmony export */   "CanvasPoint": function() { return /* reexport safe */ _canvas_point__WEBPACK_IMPORTED_MODULE_3__.CanvasPoint; },
/* harmony export */   "useCanvasContext": function() { return /* reexport safe */ _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_4__.useCanvasContext; }
/* harmony export */ });
/* harmony import */ var _canvas_bar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./canvas-bar */ "./canvas-bar.tsx");
/* harmony import */ var _canvas_group__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./canvas-group */ "./canvas-group.tsx");
/* harmony import */ var _canvas_curve__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./canvas-curve */ "./canvas-curve.tsx");
/* harmony import */ var _canvas_point__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./canvas-point */ "./canvas-point.tsx");
/* harmony import */ var _hooks_use_canvas_context__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./hooks/use-canvas-context */ "./hooks/use-canvas-context.ts");
