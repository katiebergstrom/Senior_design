...
declare class VictoryVoronoiBase extends React.Component<VictoryVoronoiProps> {
    ...
    static getBaseProps(props: VictoryVoronoiProps): any;
    static expectedComponents: (keyof VictoryVoronoiProps)[];
    shouldAnimate(): boolean;
    render(): React.ReactElement;
}
export declare const VictoryVoronoi: {
...
} & typeof VictoryVoronoiBase;
export {};
//# sourceMappingURL=victory-voronoi.d.ts.map