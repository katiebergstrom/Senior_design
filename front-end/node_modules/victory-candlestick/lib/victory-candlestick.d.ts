...
import { StringOrNumberOrCallback, EventPropTypeInterface, OrientationTypes, VictoryCommonProps, VictoryDatableProps, VictoryLabelStyleObject, VictoryMultiLabelableProps, VictoryStyleObject, NumberOrCallback, EventsMixinClass } from "victory-core";
...
export interface VictoryCandlestickProps extends Omit<VictoryCommonProps, "polar">, VictoryDatableProps, VictoryMultiLabelableProps {
    candleColors?: {
        positive?: string;
        negative?: string;
    };
