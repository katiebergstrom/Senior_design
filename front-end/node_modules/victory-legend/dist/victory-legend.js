...
const getColorScale = props => {
  ...
  return typeof colorScale === "string" ? victory_core__WEBPACK_IMPORTED_MODULE_3__.getColorScale(colorScale, theme) : colorScale || [];
};
...
/* harmony import */ var _path__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./path */ "../../victory-core/es/victory-primitives/path.js");
...
const getPath = props => {
  ...
  const pathFunctions = _victory_util_point_path_helpers__WEBPACK_IMPORTED_MODULE_2__;
...
const evaluateProps = props => {
   ...
   */
  const ariaLabel = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.ariaLabel, props);
  const desc = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.desc, props);
  const id = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.id, props);
  const size = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.size, props);
  const style = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateStyle(props.style, props);
  const symbol = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.symbol, props);
  const tabIndex = _victory_util_helpers__WEBPACK_IMPORTED_MODULE_3__.evaluateProp(props.tabIndex, props);
  return Object.assign({}, props, {
    ariaLabel,
    desc,
    id,
...
const defaultProps = {
  pathComponent: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_path__WEBPACK_IMPORTED_MODULE_4__.Path, null),
  role: "presentation",
  shapeRendering: "auto"
};
const Point = initialProps => {
  const props = evaluateProps(lodash_defaults__WEBPACK_IMPORTED_MODULE_0___default()({}, initialProps, defaultProps));
  const userProps = _victory_util_user_props__WEBPACK_IMPORTED_MODULE_5__.getSafeUserProps(props);
