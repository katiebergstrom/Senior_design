...
function getChildren(initialProps, childComponents, calculatedProps) {
  ...
  return children.map((child, index) => {
    ...
    const style = role === "voronoi" || role === "tooltip" || role === "label" ? child.props.style : victory_core__WEBPACK_IMPORTED_MODULE_3__.getChildStyle(child, index, newCalculatedProps, theme);
