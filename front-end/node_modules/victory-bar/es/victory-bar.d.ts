...
export declare type VictoryBarCornerRadiusKey = "top" | "bottom" | "topLeft" | "topRight" | "bottomLeft" | "bottomRight";
export declare type VictoryBarCornerRadiusObject = Partial<Record<VictoryBarCornerRadiusKey, NumberOrCallback>>;
export declare type VictoryBarTTargetType = "data" | "labels" | "parent";
export declare type VictoryBarAlignmentType = "start" | "middle" | "end";
